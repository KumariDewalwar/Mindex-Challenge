...
namespace code_challenge.Tests.Integration
{
    ...
    public class EmployeeControllerTests
    {
        ...
        public void AddEmployeeCompensation_Returns_Created()
        {
            ...
            var compensationRecord = new Compensation()
            {
                EmployeeId = "16a596ae-edd3-4847-99fe-c4518e82c86f",
                Salary = 70.00,
                EffectiveDate = DateTime.Parse("2024-06-14T00:00:00Z")
            };
            ...
            var newCompensationRecord = postResponse.DeserializeContent<Compensation>();
